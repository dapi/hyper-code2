...
| `NW-02` | Compare target network authority contracts and candidate mechanisms | `in_progress` | [#32](https://github.com/dapi/hyper-code2/issues/32), [R-032](../memory-bank/research/R-032/README.md); v5 adds bounded committed loader/matcher/captured-dispatch evidence, but authority defaults/inheritance, arbitrary overlays, real reachability, persistent restart and process separation remain before synthesis |
| `NW-03` | Compare secret non-transit enforcement mechanisms | `in_progress` | [#33](https://github.com/dapi/hyper-code2/issues/33), [R-033](../memory-bank/research/R-033/README.md); corrected V5.2 passed exact-freeze pre-review, one contained collection and post-review, so bounded synthesis is active; recommendation, production proof and owner decision remain open |
...
| `NW-05` | Independently review evidence, record owner dispositions, and route only accepted handoffs | `in_progress` | R-032 V5, R-033 V5.2 and R-034 V3 have independent bounded reviews; only R-033 has entered synthesis, and no ADR or delivery follows without a separate owner decision |
