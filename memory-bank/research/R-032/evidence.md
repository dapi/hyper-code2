...
| `SRC-08` | [V6.2 clean additive WIP package](../../../.protocols/experiments/r032-v6_2/README.md), [semantic contract](../../../.protocols/experiments/r032-v6_2/semantic-contract.ts) and [author self-test](../../../.protocols/experiments/r032-v6_2/self-test.ts) | 2026-08-13; HEAD `7828ad9bb3f1d8084598f20cfa6738a628609cc5`; no ready freeze | In-memory contract validation only | `collectionUnauthorized`; runtime collector, no-spawn outer preflight, OS containment and full carrier are intentionally not claimed complete |
