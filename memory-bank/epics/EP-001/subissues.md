...
| `EP-SI-04` | Restore immutable fork inheritance semantics | `W2A` | `DR-05`, active UC-003; tracker `#17` | blocked on an accepted persistent contract | [#27](https://github.com/dapi/hyper-code2/issues/27); Bug Fix Flow stopped because every correct fix selects a new storage contract; [#34](https://github.com/dapi/hyper-code2/issues/34) and [R-034](../../research/R-034/README.md) preserve bounded comparison evidence but no accepted representation |
...
| `EP-SI-06` | Close unauthenticated network-to-process authority | `W2B` | security boundary, `PRD-002 RISK-01` | target contract accepted; mechanism selection terminal inconclusive and delivery blocked | [#29](https://github.com/dapi/hyper-code2/issues/29), [R-029](../../research/R-029/README.md), [#32](https://github.com/dapi/hyper-code2/issues/32), [R-032](../../research/R-032/decision.md); route defaults, reachability, client lifecycle and process separation require demand-triggered downstream owners |
| `EP-SI-07` | Decide and verify secret non-transit with sentinel evidence | `W2B` | `BR-05`, `VAL-08` | non-terminal direction accepted; remaining mechanism synthesis open | [#18](https://github.com/dapi/hyper-code2/issues/18), [R-018](../../research/R-018/README.md), [#33](https://github.com/dapi/hyper-code2/issues/33), [R-033](../../research/R-033/README.md); redaction-only excluded as standalone boundary, no choice among `CAND-01/02/03/05`, #19 remains parked |
