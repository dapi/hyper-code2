...
| `EP-SI-06` | Close unauthenticated network-to-process authority | `W2B` | security boundary, `PRD-002 RISK-01` | validated bounded gap; delivery pending | [#29](https://github.com/dapi/hyper-code2/issues/29), [R-029](../../research/R-029/README.md); mechanism/reachability undecided |
| `EP-SI-07` | Decide and verify secret non-transit with sentinel evidence | `W2B` | `BR-05`, `VAL-08` | validated sampled gap; mechanism pending | [#18](https://github.com/dapi/hyper-code2/issues/18), [R-018](../../research/R-018/README.md); corrected named controls signed off, mechanism undecided |
